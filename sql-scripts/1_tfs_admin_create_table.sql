...
ALTER TABLE tfs_admin_user
  ADD CONSTRAINT UK_user_name UNIQUE (user_name);
-- admin/admin123
INSERT INTO `tfs_admin_user` VALUES (1, '$2a$10$Ohb6kWObdqM231o8lzIkT.AWkApqhEe2XNL2akji9y0wzREdOa37q', 'admin');
